...
entity masterOut_v1_0_M00_AXI is
	generic (
	...
	port (
        ...
        TRIG_WORD   : in std_logic_vector(3 downto 0);
		-- User ports ends
...
end masterOut_v1_0_M00_AXI;

architecture implementation of masterOut_v1_0_M00_AXI is
	      ...
	      begin                                                                            
	    	if (rising_edge (M_AXI_ACLK)) then                                              
	    	  if (M_AXI_ARESETN = '0' or init_txn_pulse = '1') then                                                
	    	    ...
	    	    -- Signals a new write address/ write data is                               
	    	    -- available by user logic                                                  
	    	    axi_awaddr <= axi_awaddr + x"00000004";                                     
	    	  end if;                                                                       
	    	end if;                                                                         
	      end process;                                                                     
	   	  ...
	   	  begin                                                                         
	   	    if (rising_edge (M_AXI_ACLK)) then                                          
	   	      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1' ) then                                            
	   	        ...
	   	        -- Signals a new write address/ write data is                           
	   	        -- available by user logic                                              
	   	        axi_araddr <= axi_araddr + x"00000004";                                 
	   	      end if;                                                                   
	   	    end if;                                                                     
	   	  end process;                                                                  
		  ...
		  begin                                                                             
		    if (rising_edge (M_AXI_ACLK)) then                                              
		      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1') then                                                
		        ...
		        -- Signals a new write address/ write data is                               
		        -- available by user logic                                                  
--Ian	        axi_wdata <= C_M_START_DATA_VALUE + EXT(write_index,C_M_AXI_DATA_WIDTH);    
                axi_wdata(3 downto 0) <= TRIG_WORD;
		      end if;                                                                       
		    end if;                                                                         
		  end process;                                                                      
	    ...
	    begin                                                                              
	      if (rising_edge (M_AXI_ACLK)) then                                               
	        if (M_AXI_ARESETN = '0' or init_txn_pulse = '1' ) then                                                 
	          ...
	          -- Signals a new write address/ write data is                                
	          -- available by user logic                                                   
	          expected_rdata <= C_M_START_DATA_VALUE + EXT(read_index,C_M_AXI_DATA_WIDTH); 
	        end if;                                                                        
	      end if;                                                                          
	    end process;                                                                       
	  ...
	  begin                                                                                             
	    if (rising_edge (M_AXI_ACLK)) then                                                              
	      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1') then                                                                
	        ...
	        if (write_index = CONV_STD_LOGIC_VECTOR(C_M_TRANSACTIONS_NUM, TRANS_NUM_BITS+1) and M_AXI_AWREADY = '1') then
	          last_write  <= '1';                                                                       
	        end if;                                                                                     
	      end if;                                                                                       
	    end if;                                                                                         
	  ...
	  begin                                                                                             
	    if (rising_edge (M_AXI_ACLK)) then                                                              
	      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1') then                                                                
	        ...
	        if (read_index = CONV_STD_LOGIC_VECTOR(C_M_TRANSACTIONS_NUM, TRANS_NUM_BITS+1) and (M_AXI_ARREADY = '1') ) then
