...
entity testmaster_v1_0_M00_AXI is
	generic (
	...
	port (
        ...
        TRIG_WORD(3 downto 0) : in std_logic_vector;
		-- User ports ends
...
end testmaster_v1_0_M00_AXI;

architecture implementation of testmaster_v1_0_M00_AXI is
		  ...
		  begin                                                                             
		    if (rising_edge (M_AXI_ACLK)) then                                              
		      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1') then                                                
		        ...
		        -- Signals a new write address/ write data is                               
		        -- available by user logic                                                  
		        axi_wdata <= C_M_START_DATA_VALUE + EXT(write_index,C_M_AXI_DATA_WIDTH);    
		      end if;                                                                       
		    end if;                                                                         
		  end process;                                                                      
