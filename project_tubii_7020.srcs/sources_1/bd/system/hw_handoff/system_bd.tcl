...
proc create_root_design { parentCell } {
  ...
  # Create instance: register_mux_1, and set properties
  set register_mux_1 [ create_bd_cell -type ip -vlnv user.org:user:register_mux:1.0 register_mux_1 ]
  ...
  connect_bd_net -net clk_in [get_bd_ports Clk_in] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M12_ACLK] [get_bd_pins axi_interconnect_0/M14_ACLK] [get_bd_pins axi_interconnect_0/M15_ACLK] [get_bd_pins axi_interconnect_0/M16_ACLK] [get_bd_pins axi_interconnect_0/M17_ACLK] [get_bd_pins axi_interconnect_0/M19_ACLK] [get_bd_pins axi_interconnect_0/M20_ACLK] [get_bd_pins axi_interconnect_0/M22_ACLK] [get_bd_pins axi_interconnect_0/M28_ACLK] [get_bd_pins clockComparison_0/clk_comp] [get_bd_pins clockCounter_1/s00_axi_aclk] [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins fifo_generator_1/clk] [get_bd_pins fifo_readout_0/s00_axi_aclk] [get_bd_pins genericDelay/s00_axi_aclk] [get_bd_pins genericPulser/s00_axi_aclk] [get_bd_pins prescaleTrigger_0/s00_axi_aclk] [get_bd_pins smellieDelay/s00_axi_aclk] [get_bd_pins smelliePulser/s00_axi_aclk] [get_bd_pins tellieDelay/s00_axi_aclk] [get_bd_pins telliePulser/s00_axi_aclk] [get_bd_pins testPulser_0/s00_axi_aclk] [get_bd_pins triggers_0/s00_axi_aclk] [get_bd_pins trigwordfifo_0/s00_axi_aclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins MZ_Happy/s00_axi_aclk] [get_bd_pins ShiftRegisters_0/s00_axi_aclk] [get_bd_pins anticoincTrigger_0/s00_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axi_interconnect_0/M10_ACLK] [get_bd_pins axi_interconnect_0/M11_ACLK] [get_bd_pins axi_interconnect_0/M13_ACLK] [get_bd_pins axi_interconnect_0/M18_ACLK] [get_bd_pins axi_interconnect_0/M21_ACLK] [get_bd_pins axi_interconnect_0/M23_ACLK] [get_bd_pins axi_interconnect_0/M24_ACLK] [get_bd_pins axi_interconnect_0/M25_ACLK] [get_bd_pins axi_interconnect_0/M26_ACLK] [get_bd_pins axi_interconnect_0/M27_ACLK] [get_bd_pins axi_interconnect_0/M29_ACLK] [get_bd_pins axi_interconnect_0/M30_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins burstTrigger_0/s00_axi_aclk] [get_bd_pins clockComparison_0/s00_axi_aclk] [get_bd_pins clockCounter_0/s00_axi_aclk] [get_bd_pins clockLogic_0/s00_axi_aclk] [get_bd_pins coincTrigger_0/s00_axi_aclk] [get_bd_pins comboTrigger_0/s00_axi_aclk] [get_bd_pins countDisplay_0/s00_axi_aclk] [get_bd_pins ellie_control_0/s00_axi_aclk] [get_bd_pins gtDelay/s00_axi_aclk] [get_bd_pins implement_gtid_0/s00_axi_aclk] [get_bd_pins oneshot_pulse_0/s00_axi_aclk] [get_bd_pins oneshot_pulse_1/s00_axi_aclk] [get_bd_pins prescaleSignal_0/s00_axi_aclk] [get_bd_pins prescaleSignal_1/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins register_mux_0/s00_axi_aclk] [get_bd_pins register_mux_1/s00_axi_aclk]
  ...
  connect_bd_net -net register_mux_1_mux_out [get_bd_pins genericDelay/pulse_in] [get_bd_pins register_mux_0/mux_in1] [get_bd_pins register_mux_1/mux_out]
  connect_bd_net -net s00_axi_userin_1 [get_bd_ports generic_delay_in] [get_bd_pins register_mux_1/mux_in0]
  connect_bd_net -net s00_axi_userin_2_1 [get_bd_ports tellie_delay_in] [get_bd_pins util_vector_logic_11/Op1]
  connect_bd_net -net s00_axi_userin_3_1 [get_bd_ports smellie_delay_in] [get_bd_pins register_mux_1/mux_in1] [get_bd_pins smellieDelay/pulse_in]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x43C24000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs register_mux_1/S00_AXI/S00_AXI_reg] SEG_register_mux_1_S00_AXI_reg
