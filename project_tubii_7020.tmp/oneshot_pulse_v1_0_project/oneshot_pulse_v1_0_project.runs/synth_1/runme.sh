...
HD_PWD='/home/zummo/snoplus/TUBii/project_tubii_7020/project_tubii_7020.tmp/oneshot_pulse_v1_0_project/oneshot_pulse_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oneshot_pulse_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oneshot_pulse_v1_0.tcl
